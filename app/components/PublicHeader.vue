<template>
  <header class="sticky top-0 z-50">
    <!-- Top info bar -->
    <div class="bg-gray-800 text-gray-300 text-sm hidden md:block">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-9">
          ...
          <div class="flex items-center gap-3">
            <a href="https://www.instagram.com/ploverindustrial79/" target="_blank" class="hover:text-white transition" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/profile.php?id=61573017871719" target="_blank" class="hover:text-white transition" aria-label="Facebook">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <NuxtLink to="/" class="flex items-center">
            <span class="text-2xl font-bold text-blue-600">PLOVER</span>
          </NuxtLink>
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="relative hidden md:block">
              ...
              />
              <svg class="absolute right-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="mobileMenuOpen" class="lg:hidden pb-4 space-y-1">
          ...
          <div class="py-2">
            <span class="block text-gray-700 font-medium mb-1">About us</span>
